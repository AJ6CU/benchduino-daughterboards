...
// Modified July 22, 2020 by Mark Hatch (AJ6CU) to support Teensy
...
// ==============================================================================
  const int PinA  = 2;         const int PinB  = 3;         const int PinSW = 4;    // Rotary encoder
  const int button1 = 5;
  const int button2 = 6;
  const int button3 = 7;
  const int button4 = 8;
...
void update_freq() {
  long newPosition = bdEnc.read();
  if(newPosition != oldPosition) {
    Serial.print("freq = "); Serial.println (freq);
    Serial.print("oldPosition = "); Serial.println (oldPosition);
    Serial.print("newPosition = "); Serial.println (newPosition);
    freq=freq + (newPosition-oldPosition)*freqStep;
    Serial.print("freq = "); Serial.println (freq);
