...
// ==============================================================================
// NOTE: These PIN assignments are very different than the original one. This is because of
// Fewer pins on the XIAO
//
  const int PinA  = 6;         const int PinB  = 7;         const int PinSW = 8;    // Rotary encoder
  const int button1 = 0;
  const int button2 = 1;
  const int button3 = 2;
  const int button4 = 3;
