...
// Modified by Mark AJ6CU on Sept 13 for ESP-S2-Saola
// Specific board was:
...
// ==============================================================================
  ...
  const int led1 = 9;
  const int led2 = 10;
  const int led3 = 11;  //Note that GPIO11-GPIO13 collide with SPI bus, don't use together...
  const int led4 = 12;
...
// ==============================================================================
 ...
 U8G2_SSD1306_128X64_NONAME_F_HW_I2C u8g(U8G2_R0,SCLPIN,SDAPIN, U8X8_PIN_NONE);
